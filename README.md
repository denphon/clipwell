...
- **Preview window**: open an entry's full content in a separate resizable window (centered, text selection, rich/plain toggle, clickable links). Images are shown at their real physical size (DPI-aware) and support scroll-to-zoom, drag-to-pan and middle-click reset.
...
- **Paste as Markdown / HTML**: from an entry's right-click menu, paste rich content as Markdown source, or render a Markdown entry to HTML.
